<p><strong><?php _e('Paystack', 'event_espresso'); ?></strong></p>
<p>
<?php _e('Adjust the settings for the Paystack payment gateway.', 'event_espresso'); ?>
</p>
<p>
<?php printf( __( 'Please contact Paystack to find what currencies are supported', 'event_espresso' ) ); ?>
</p>
<p><strong><?php _e('Paystack Settings', 'event_espresso'); ?></strong></p>
<ul>
	<li>
...
<?php _e('The login used to login to Paystack.', 'event_espresso'); ?>
</li>
<li>
